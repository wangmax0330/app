...
public class JsonUtils {
    public static String getJsonResult(String isSuc, String msg, String[] paramValues) {
	String arrs = ":[";
	if (paramValues != null) {
	...
	arrs = arrs + "]";
	return "{\"isSuc\":\"" + isSuc + "\",\"msg\":\"" + msg + "\",\"attrs\"" + arrs + "}";
    }

    public static String JSON_Bean2StringWithFilter(Object ob, String[] filterFields) {
    ...
    public static String JSON_List2StringWithFilter(Object ob, PropertyFilter filter) {
	JsonConfig j = new JsonConfig();
	if (filter != null) j.setJavaPropertyFilter(filter);
