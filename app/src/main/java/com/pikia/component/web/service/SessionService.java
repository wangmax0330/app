...
public abstract interface SessionService {
	public static final String LOCALE_SESSION_ATTRIBUTE_NAME = SimpleController.class.getName()
			+ ".LOCALE";
	...
	public abstract void setAttr(HttpServletRequest paramHttpServletRequest, String paramString,
			Object paramObject);
	...
	public abstract void setAttr(HttpSession paramHttpSession, String paramString,
			Object paramObject);
