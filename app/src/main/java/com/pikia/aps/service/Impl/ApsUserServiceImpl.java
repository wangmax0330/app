...
import com.pikia.component.extra.service.impl.ModelCrudServiceSupport;
...
public class ApsUserServiceImpl extends ModelCrudServiceSupport implements ApsUserService {
	...
	return this.queryForPaginationList(new MyBatisRepository() {
		...
		return apsUserRepository.getPagedModelIds(startIndex, pageSize, sortField, null,
			null);
	    }
	}, queryContext);
    }
	...
	jsonMap.put("cityId", tmp.getCityId());
