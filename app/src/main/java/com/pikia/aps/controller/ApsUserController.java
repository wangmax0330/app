...
public class ApsUserController {
	...
	@RequestMapping(value = "/a-admin/users/list", method = {
			RequestMethod.POST, RequestMethod.GET })
	public void adminIndexPage(HttpServletRequest request,
		...
		ResponseUtils.writeMessage(response,
				pagedList.pageDescription(apsUserService.getJsonList(list))
						.toString());
	}

	@RequestMapping(value = "/d-front/logout", method = { RequestMethod.POST,
			RequestMethod.GET })
	public String logout(HttpServletRequest request,
			HttpServletResponse response, ApsUserDomain user) {
		try {
