...
<head>
    ...
    <link rel="icon" href="${rc.contextPath}/dev-lib/assets/favicon.ico">
...
<body>
    ...
    <script src="${rc.contextPath}/dev-lib/assets/bootstrap/js/bootstrap.min.js"></script>
</body>
