                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left no-padding bordered-left-2 bordered-palegreen">
                                            <img src="${rc.contextPath}/res/assets/img/avatars/John-Smith.jpg" style="width:65px; height:65px;">
                                        </div>
                                                ...
                                                <div class="tickets-container">
                                                    <ul class="tickets-list">
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${rc.contextPath}/res/assets/img/avatars/adam-jansen.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${rc.contextPath}/res/assets/img/avatars/divyia.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${rc.contextPath}/res/assets/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${rc.contextPath}/res/assets/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${rc.contextPath}/res/assets/img/avatars/John-Smith.jpg" class="user-avatar">
